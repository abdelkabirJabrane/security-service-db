	...
	CommandLineRunner init(UserRepository userRepository,
		...
		return args -> {
			...
			if (!existingAdmin.isPresent()) {
				...
				Optional<Role> optAdminRole = Optional.ofNullable(roleRepository.findByRoleName("ADMIN"));
				Role adminRole;
				...
				Optional<Role> optUserRole = Optional.ofNullable(roleRepository.findByRoleName("USER"));
				Role userRole;
